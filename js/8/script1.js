...
// const  save_btn = document.getElementById('input1')
//
//
// let seveuser = function (i) {
//     if (!localStorage.getItem('name${i}')) {
//         localStorage.setItem('name${i}', name.value)
//         localStorage.setItem('tel${i}', tel.value)
//         localStorage.setItem('gmai${i}', gmail.value)
...
//
//     document.body.appendChild(fieldest)
//
