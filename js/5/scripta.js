...
//
// let title = '<a>';
// let action = 'Ter <a> является одним из важных элементов HTML и предназначен для создания ссылок. В зависимости от присутствия атрибутов name или href тег <a> устанавливает ссылку или якорь. Якорем называется закладка внутри страницы, которую можно указать в качестве цели ссылки. При использовании ссылки, которая указывает на якорь, происходит переход к закладке внутри веб-страницы.`;'
// let attibytes = [
...
//
// let title1 = '<div>';
// let action1 = 'Єлемент <div> является блочным элементом и предназначен для выделения фрагмента документа с целью изменения вида содержимого. Как правило, вид блока управляется с помощью стилей. Чтобы не описывать каждый раз стиль внутри тега, можно выделить стиль во внешнюю таблицу стилей, а для тега добавить атрибут class или id с именем селектора.`;'
// let attibytes1 = [
//     {titleOfAttr: 'align', actionOfAttr: 'Задает выравнивание содержимого тега <div>.'},
//     {titleOfAttr: 'title', actionOfAttr: 'Добавляет всплывающую подсказку к содержимому'},
//
// ];
// let div = new Html(title, action1, attibytes1)
// console.log(div)
//
//
// let title2 = '<h1>';
...
// function Sinderela (name, age, size) {
//     this.name = name;
//     this.age = age;
//     this.size = size;
// }
// let Ivanka = new Sinderela('Ivanka', 19, 37);
// let Ira = new Sinderela('Ira', 24, 12);
// let Olga = new Sinderela('Olga', 11, 32);
// let Olha = new Sinderela('Olha', 31, 22);
// let Diana = new Sinderela('Diana', 44, 24);
//
// let girls = ['Ivanka', 'Ira', 'Olga', 'Olha','Diana'];
//
...
//     }
// }
//  let dima = new Prince('dima',17,34);
//
// dima.findMyPrincess(girls)
